...
{
  public class AddBankInfoResponsePresenter
  {
    public AddBankViewModel Handle(AddBankResponseMessage message, AddBankViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddBankViewModel();
      }
