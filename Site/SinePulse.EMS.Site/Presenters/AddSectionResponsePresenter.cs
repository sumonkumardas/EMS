...
{
  public class AddSectionResponsePresenter
  {
    public AddSectionViewModel Handle(AddSectionResponseMessage message, AddSectionViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddSectionViewModel();
      }
