...
{
  public class AddDesignationResponsePresenter
  {
    public AddDesignationViewModel Handle(AddDesignationResponseMessage message, AddDesignationViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddDesignationViewModel();
      }
