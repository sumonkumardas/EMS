...
{
  public class EditClassRoutineResponsePresenter
  {
    public EditClassRoutineViewModel Handle(AddClassRoutineResponseMessage message, EditClassRoutineViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new EditClassRoutineViewModel();
      }
