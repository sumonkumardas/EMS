...
{
  public class AddSeatPlanResponsePresenter
  {
    public AddSeatPlanViewModel Handle(ValidatedData<AddSeatPlanResponseMessage> message, AddSeatPlanViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddSeatPlanViewModel();
      }
