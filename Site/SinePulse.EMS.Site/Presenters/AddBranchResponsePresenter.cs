...
{
  public class AddBranchResponsePresenter
    {
    public AddBranchViewModel Handle(AddBranchResponseMessage message, AddBranchViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddBranchViewModel();
      }
