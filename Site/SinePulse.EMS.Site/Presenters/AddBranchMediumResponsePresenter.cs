...
{
  public class AddBranchMediumResponsePresenter
  {
    public AddBranchMediumViewModel Handle(AddBranchMediumResponseMessage message, AddBranchMediumViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddBranchMediumViewModel();
      }
