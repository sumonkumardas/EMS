...
{
  public class EditStudentResponsePresenter
  {
    public EditStudentViewModel Handle(EditStudentResponseMessage message, EditStudentViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new EditStudentViewModel();
      }
