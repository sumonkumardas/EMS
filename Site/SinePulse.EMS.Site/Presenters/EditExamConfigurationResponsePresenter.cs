...
{
  public class EditExamConfigurationResponsePresenter
  {
    public ExamConfigurationViewModel Handle(EditExamConfigurationResponseMessage message, ExamConfigurationViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new ExamConfigurationViewModel();
      }
