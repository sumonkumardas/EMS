...
{
  public class AddStudentSectionResponsePresenter
  {
    public AddStudentSectionViewModel Handle(AddStudentSectionResponseMessage message,AddStudentSectionViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddStudentSectionViewModel();
      }
