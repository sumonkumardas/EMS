...
{
  public class AddClassRoutineResponsePresenter
  {
    public AddClassRoutineViewModel Handle(AddClassRoutineResponseMessage message, AddClassRoutineViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddClassRoutineViewModel();
      }
