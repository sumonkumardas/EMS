...
{
  public class AddStudentResponsePresenter
  {
    public AddStudentViewModel Handle(ValidatedData<AddStudentResponseMessage> message,
      ...
      GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddStudentViewModel();
      }
