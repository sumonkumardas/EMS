...
{
  public class AddClassTestResponsePresenter
  {
    public AddClassTestViewModel Handle(AddClassTestResponseMessage message, AddClassTestViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddClassTestViewModel();
      }
