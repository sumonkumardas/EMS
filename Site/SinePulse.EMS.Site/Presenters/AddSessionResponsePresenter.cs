...
{
  public class AddSessionResponsePresenter
  {
    public AddSessionViewModel Handle(AddSessionResponseMessage message, AddSessionViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddSessionViewModel();
      }
