...
{
  public class AddTermTestResponsePresenter
  {
    public AddTermTestViewModel Handle(AddTermTestResponseMessage message,AddTermTestViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddTermTestViewModel();
      }
