...
{
  public class AddOptionalSubjectResponsePresenter
  {
    public AddOptionalSubjectViewModel Handle(AddOptionalSubjectResponseMessage message,AddOptionalSubjectViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddOptionalSubjectViewModel();
      }
