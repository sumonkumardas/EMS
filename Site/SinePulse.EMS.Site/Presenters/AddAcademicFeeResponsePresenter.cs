...
{
  public class AddAcademicFeeResponsePresenter
  {
    public AddAcademicFeeViewModel Handle(AddAcademicFeeResponseMessage message, AddAcademicFeeViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddAcademicFeeViewModel();
      }
