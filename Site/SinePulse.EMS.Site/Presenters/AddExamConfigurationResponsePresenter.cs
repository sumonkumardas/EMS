...
{
  public class AddExamConfigurationResponsePresenter
  {
    public AddExamConfigurationViewModel Handle(AddExamConfigurationResponseMessage message, AddExamConfigurationViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddExamConfigurationViewModel();
      }
