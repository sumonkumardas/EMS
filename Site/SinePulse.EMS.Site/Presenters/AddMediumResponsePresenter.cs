...
{
  public class AddMediumResponsePresenter
  {
    public AddMediumViewModel Handle(AddMediumResponseMessage message, AddMediumViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddMediumViewModel();
      }
