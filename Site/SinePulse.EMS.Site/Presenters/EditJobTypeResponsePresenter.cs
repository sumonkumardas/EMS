...
{
  public class EditJobTypeResponsePresenter
  {
    public JobTypeViewModel Handle(EditJobTypeResponseMessage message, JobTypeViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new JobTypeViewModel();
      }
