...
{
  public class EditResultGradeResponsePresenter
  {
    public ResultGradeViewModel Handle(ValidatedData<EditResultGradeResponseMessage> message,ResultGradeViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new ResultGradeViewModel();
      }
