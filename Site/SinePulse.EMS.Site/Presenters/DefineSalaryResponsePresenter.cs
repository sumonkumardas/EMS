...
{
  public class DefineSalaryResponsePresenter
  {
    public DefineSalaryViewModel Handle(DefineSalaryResponseMessage message,DefineSalaryViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new DefineSalaryViewModel();
      }
