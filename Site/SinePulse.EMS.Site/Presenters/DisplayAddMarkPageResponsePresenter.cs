...
{
  public class DisplayAddMarkPageResponsePresenter
  {
    public AddMarkViewModel Handle(ValidatedData<DisplayAddMarkPageResponseMessage> message, AddMarkViewModel viewModel,
