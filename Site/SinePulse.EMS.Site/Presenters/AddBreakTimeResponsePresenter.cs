...
{
  public class AddBreakTimeResponsePresenter
  {
    public AddBreakTimeViewModel Handle(AddBreakTimeResponseMessage message, AddBreakTimeViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddBreakTimeViewModel();
      }
