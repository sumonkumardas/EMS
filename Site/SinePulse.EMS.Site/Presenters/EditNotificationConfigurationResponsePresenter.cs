...
{
  public class EditNotificationConfigurationResponsePresenter
  {
    public NotificationConfigurationViewModel Handle(EditNotificationConfigurationResponseMessage message, NotificationConfigurationViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new NotificationConfigurationViewModel();
      }
