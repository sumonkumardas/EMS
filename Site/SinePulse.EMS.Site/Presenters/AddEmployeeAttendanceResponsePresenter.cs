...
{
  public class AddEmployeeAttendanceResponsePresenter
  {
    public AddEmployeeAttendanceViewModel Handle(AddEmployeeAttendanceResponseMessage message, AddEmployeeAttendanceViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddEmployeeAttendanceViewModel();
      }
