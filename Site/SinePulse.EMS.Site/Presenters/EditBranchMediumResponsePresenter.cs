...
{
  public class EditBranchMediumResponsePresenter
  {
    public EditBranchMediumViewModel Handle(EditBranchMediumResponseMessage message, EditBranchMediumViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new EditBranchMediumViewModel();
      }
