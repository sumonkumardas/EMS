...
{
  public class PromoteStudentsResponsePresenter
  {
    public PromoteStudentsViewModel Handle(ValidatedData<PromoteStudentsResponseMessage> message,
      PromoteStudentsViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new PromoteStudentsViewModel();
      }
