...
{
  public class AddEmployeeEducationalQualificationResponsePresenter
  {
    public AddEmployeeEducationalQualificationViewModel Handle(AddEmployeeEducationalQualificationResponseMessage message, AddEmployeeEducationalQualificationViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddEmployeeEducationalQualificationViewModel();
      }
