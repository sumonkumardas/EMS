...
{
  public class AddMarkResponsePresenter
  {
    public AddMarkViewModel Handle(ValidatedData<AddMarkResponseMessage> message, AddMarkViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddMarkViewModel();
      }
