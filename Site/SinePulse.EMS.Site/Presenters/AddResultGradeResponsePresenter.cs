...
{
  public class AddResultGradeResponsePresenter
  {
    public AddResultGradeViewModel Handle(ValidatedData<AddResultGradeResponseMessage> message, AddResultGradeViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddResultGradeViewModel();
      }
