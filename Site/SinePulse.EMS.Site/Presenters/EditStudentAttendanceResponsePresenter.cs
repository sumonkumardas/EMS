...
{
  public class EditStudentAttendanceResponsePresenter
  {
    public StudentAttendanceViewModel Handle(EditStudentAttendanceResponseMessage message, StudentAttendanceViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new StudentAttendanceViewModel();
      }
