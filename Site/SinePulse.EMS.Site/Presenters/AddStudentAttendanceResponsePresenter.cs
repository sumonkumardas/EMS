...
{
  public class AddStudentAttendanceResponsePresenter
  {
    public AddStudentAttendanceViewModel Handle(AddStudentAttendanceResponseMessage message, AddStudentAttendanceViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddStudentAttendanceViewModel();
      }
