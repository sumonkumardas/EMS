...
{
  public class FeeCollectionResponsePresenter
  {
    public FeeCollectionViewModel Handle(FeeCollectionResponseMessage message, FeeCollectionViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new FeeCollectionViewModel();
      }
