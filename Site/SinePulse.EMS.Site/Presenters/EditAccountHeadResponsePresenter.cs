...
{
  public class EditAccountHeadResponsePresenter
  {
    public AccountHeadViewModel Handle(EditAccountHeadResponseMessage message, AccountHeadViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AccountHeadViewModel();
      }
