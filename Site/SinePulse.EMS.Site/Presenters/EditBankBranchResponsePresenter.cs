...
{
  public class EditBankBranchResponsePresenter
  {
    public EditBankBranchViewModel Handle(EditBankBranchResponseMessage message, EditBankBranchViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new EditBankBranchViewModel();
      }
