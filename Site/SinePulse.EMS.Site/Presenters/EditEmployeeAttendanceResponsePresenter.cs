...
{
  public class EditEmployeeAttendanceResponsePresenter
  {
    public EmployeeAttendanceViewModel Handle(EditEmployeeAttendanceResponseMessage message, EmployeeAttendanceViewModel viewModel,
