...
{
  public class AddEmployeePersonalInfoResponsePresenter
  {
    public AddEmployeePersonalInfoViewModel Handle(AddEmployeePersonalInfoResponseMessage message, AddEmployeePersonalInfoViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddEmployeePersonalInfoViewModel();
      }
