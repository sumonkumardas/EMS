...
{
  public class ShowCurrentSessionListResponsePresenter
  {
    public ShowSessionListViewModel Handle(ShowCurrentSessionListResponseMessage message, ShowSessionListViewModel viewModel,
