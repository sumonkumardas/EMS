...
{
  public class AddEmployeeAddressResponsePresenter
  {
    public AddEmployeeAddressViewModel Handle(AddEmployeeAddressResponseMessage message, AddEmployeeAddressViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddEmployeeAddressViewModel();
      }
