...
{
  public class EditBankResponsePresenter
  {
    public EditBankViewModel Handle(EditBankResponseMessage message, EditBankViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new EditBankViewModel();
      }
