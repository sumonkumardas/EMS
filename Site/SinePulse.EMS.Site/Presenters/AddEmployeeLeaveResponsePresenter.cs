...
{
  public class AddEmployeeLeaveResponsePresenter
  {
    public AddEmployeeLeaveViewModel Handle(AddEmployeeLeaveResponseMessage message, AddEmployeeLeaveViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddEmployeeLeaveViewModel();
      }
