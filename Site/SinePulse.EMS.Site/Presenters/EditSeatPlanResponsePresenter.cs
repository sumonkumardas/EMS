...
{
  public class EditSeatPlanResponsePresenter
  {
    public EditSeatPlanViewModel Handle(ValidatedData<EditSeatPlanResponseMessage> message, EditSeatPlanViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new EditSeatPlanViewModel();
      }
