...
{
  public class AssignOrChangeRoomInSectionResponsePresenter
  {
    public AssignOrChangeRoomInSectionViewModel Handle(AssignOrChangeRoomInSectionResponseMessage message, AssignOrChangeRoomInSectionViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AssignOrChangeRoomInSectionViewModel();
      }
