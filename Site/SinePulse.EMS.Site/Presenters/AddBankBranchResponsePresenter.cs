...
{
  public class AddBankBranchResponsePresenter
  {
    public AddBankBranchViewModel Handle(AddBankBranchResponseMessage message, AddBankBranchViewModel viewModel,
      ModelStateDictionary modelState, GetUserAssociationResponseMessage userAssociationMessage)
    {
      ...
      {
        modelState.Clear();
        viewModel = new AddBankBranchViewModel();
      }
