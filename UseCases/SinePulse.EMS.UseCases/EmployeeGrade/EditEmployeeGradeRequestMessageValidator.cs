...
{
  public class EditEmployeeGradeRequestMessageValidator : AbstractValidator<EditEmployeeGradeRequestMessage>
  {
    private readonly IUniqueEmployeeGradePropertyChecker _uniqueEmployeeGradePropertyChecker;

    public EditEmployeeGradeRequestMessageValidator(
    ...
    private void IsUniqueMinAndMaxSalary(EditEmployeeGradeRequestMessage employeeGrade, CustomContext context)
    {
    ...
    private bool IsUniqueGradeTitle(EditEmployeeGradeRequestMessage message,string gradeTitle)
    {
      return _uniqueEmployeeGradePropertyChecker.IsUniqueEmployeeGradeTitle(message.Id,gradeTitle);
    }
  }
}