...
{
  public class
    EditEducationalQualificationRequestMessageValidator : AbstractValidator<EditEducationalQualificationRequestMessage>
  {
    public EditEducationalQualificationRequestMessageValidator()
    {
