...
{
  public class AddEmployeeAttendanceRequestMessageValidator : AbstractValidator<AddEmployeeAttendanceRequestMessage>
  {
    public AddEmployeeAttendanceRequestMessageValidator()
    {
      ...
      RuleFor(x => x.AttendanceDate).LessThanOrEqualTo(DateTime.Now).WithMessage("Entered date is a Future date!");
