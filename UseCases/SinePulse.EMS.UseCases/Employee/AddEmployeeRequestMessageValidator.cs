...
{
  public class AddEmployeeRequestMessageValidator : AbstractValidator<AddEmployeeRequestMessage>
  {
    public AddEmployeeRequestMessageValidator()
    {
      ...
      RuleFor(x => x.JoiningDate).LessThan(p => DateTime.Now).WithMessage("Joining Date must be less than Current date.");
